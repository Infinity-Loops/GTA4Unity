...
namespace RageLib.Textures
{
    public class Texture : IDisposable
    {
        ...
        private RageUnityTexture _thumbnailCache;
        ...
        public RageUnityTexture DecodeAsThumbnail()
        {
            if (_thumbnailCache == null)
            {
                RageUnityTexture image = Decode();
                ...
                _thumbnailCache = image;
            }

            return _thumbnailCache;
        }

        public RageUnityTexture Decode()
        {
            return Decode(0);
        }

        public RageUnityTexture Decode(int level)
        {
            return TextureDecoder.Decode(this, level);
        }

        public void Encode(Texture2D image)
        {
            ...
            if (_thumbnailCache != null)
            {
                //UnityEngine.Object.Destroy(_thumbnailCache);
