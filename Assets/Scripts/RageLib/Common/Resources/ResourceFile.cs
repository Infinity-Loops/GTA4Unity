...
namespace RageLib.Common.Resources
{
    public class ResourceFile : IDisposable
    {
        ...
        public void Read(Stream data)
        {
            ...
            // Restored to original strict magic check — the relaxed IsValidRSC() version
            // accepted any RSC version byte, which could let through files with different
            // struct layouts that then cause wrong field reads downstream.
