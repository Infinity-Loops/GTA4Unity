...
namespace RageLib.Common.Resources
{
    public static class ResourceUtil
    {
        ...
        // Restored to original RageLib behavior: THROW on bad offset marker.
        // The previous "silent return 0" modification caused shader param parsing to
        // silently produce TextureNameOffset=0, seek to file position 0, and read
        // garbage from the resource header as a texture name — instead of throwing
        // (caught by Shader.Read) and making the param null (= no texture, correct).
